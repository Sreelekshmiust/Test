        ...
        <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
          ...
          <div className="form-container">
            <div className="flex items-center justify-center">
              ...
              rounded-md bg-white bg-opacity-30">WeatherWealth</h3>
            ...
            <div className="flex flex-col my-10">
              ...
              {weatherData.length === 0 ?
                ...
                <>
                  ...
                  <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">Add to Favorites</button>
